      ...
      <div className="p-4 flex-1 overflow-y-auto">
        ...
        <div className="mt-8 pt-8 border-t border-gym-gray space-y-1">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-gym-lightgray hover:bg-gym-darkred hover:text-white transition-all duration-200 mt-2"
          >
